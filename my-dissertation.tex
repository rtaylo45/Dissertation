...
\documentclass[dissertation,letterpaper, draft, 12pt]{utthesis} %dissertation
...
\fancypagestyle{mylandscape}{
    ...
    \makebox[\textwidth][r]{% Right
      \rlap{\hspace{-0.4cm}% Push out of margin by \footskip
        \smash{% Remove vertical height
          \raisebox{4.40in}{% Raise vertically
...
\utbiblio{#1}{unsrt}{references-dissertation}
    ...
    \appendix    
    \include{back-matter/appendix-pade_functions}
    \include{back-matter/appendix-nuclide_list}
    \include{back-matter/appecdix-results}
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % A VITA IS REQUIRED
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \addToTOC{Vita}
