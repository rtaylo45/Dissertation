...
\begin{table}[htbp]
   \caption{\label{tab:problem4_results_taylor} Convergence Rate for Problem 4 with Absolute Error Using the Parabolic Solver}
   \centering
    \scalebox{0.85}{
   \begin{tabular}{cllllllll}
   \hline
...
\begin{table}[htbp]
   \caption{\label{tab:problem4_results_taylor} Convergence Rate for Problem 4 with Absolute Error Using the Pad\'e-method 1 Solver}
   \centering
    \scalebox{0.85}{
   \begin{tabular}{cllllllll}
   \hline
...
\begin{table}[htbp]
   \caption{\label{tab:problem4_results_taylor} Convergence Rate for Problem 4 with Absolute Error Using the Pad\'e-method 2 Solver}
   \centering
    \scalebox{0.85}{
   \begin{tabular}{cllllllll}
   \hline
